...
$query = "INSERT INTO properties (uuid, address, country, county, description, image_full, image_thumbnail, num_bathrooms, num_bedrooms, price, property_type, town, type) VALUES ('$uuid', '$address', '$country', '$county', '$description', '$image_full', '$image_thumbnail', '$num_bathrooms', '$num_bedrooms', '$price', '$property_type', '$town', '$type')";
